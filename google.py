"""
Class to search for news articles given a keyword
"""
...
from utils import (BeautifulSoup, Options, UserAgent,
...
class google_search:
    ...
    def __init__(self, keyword, newspaper_url):
        ...
        try:
            ...
            if len(driver.find_elements(by = By.XPATH, value = '//div[@id="result-stats"]'))!= 0:
                results = driver.find_elements(by = By.XPATH, value = '//div[@id="result-stats"]')[0].text
            ...
            if max_pages != 0:
                ...
                while index < 3:
                    try:
                        index += 1
                        links = driver.find_elements(by = By.XPATH, value = '//div[@class="yuRUbf"]/a')
